package com.haojiankang.framework.provider.sysmanager.controller.uploadfile;
...
public class SysUploadFileController extends BaseController<UploadFile,UploadFile> {
