...
import com.haojiankang.framework.commons.utils.security.context.ContextContainer;
import com.haojiankang.framework.commons.utils.spring.SpringUtils;
import com.haojiankang.framework.provider.sysmanager.api.model.po.sysmgr.SysConfiguration;
import com.haojiankang.framework.provider.sysmanager.api.model.vo.sysmgr.VOConfiguration;
import com.haojiankang.framework.provider.sysmanager.api.service.sysmgr.ConfigurationService;
import com.haojiankang.framework.provider.sysmanager.api.supports.DataOper;
...
import com.haojiankang.framework.provider.sysmanager.supports.sysmgr.ConfigurationUtils;
...
@Service
public class SysConfigurationServiceImpl extends BaseServiceImpl<SysConfiguration, VOConfiguration>
    ...
    public Map<String, List<VOConfiguration>> listGroup(Page page) {
        ...
        List<SysConfiguration> cfgs = (List<SysConfiguration>) page.getResult();
    ...
    @Override
    public BaseDao<SysConfiguration, Serializable> getBaseDao() {
        return configurationDao;
    }

    public boolean callBack(SysConfiguration configuration, DataOper oper) {
        Boolean flag = null;
     ...
     * @since JDK 1.8
     */
    protected void cacheDataProcessing(SysConfiguration po, DataOper oper) {
    ...
    private boolean executeCallBack(String callback, SysConfiguration configuration, DataOper oper) {
        ...
        if (null != bean) {
            try {
                blReturn = (Boolean) ObjectUtils.getObjectByBean(bean, methodName, new Object[] { configuration, oper },
                        new Class[] { SysConfiguration.class, DataOper.class });
            } catch (Exception e) {
            }
        }
        ...
        if (null == blReturn) {
            try {
                ...
                blReturn = (Boolean) ObjectUtils.getObjectByClass(clazz, methodName,
                        new Object[] { configuration, oper }, new Class[] { SysConfiguration.class, DataOper.class });
            } catch (Exception e) {
            }
        }
        return blReturn;
